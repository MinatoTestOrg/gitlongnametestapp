...
import com.minatodattebayo.gittestapp.base.model.ApplicationUserBase;
...
@Component
public abstract class TablePerimeterBaseImpl<T extends TableBase> implements IPerimeterManager<T> {
