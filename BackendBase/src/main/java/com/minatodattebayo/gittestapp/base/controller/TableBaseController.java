package com.minatodattebayo.gittestapp.base.controller;

import com.vs.rappit.base.dal.providers.PersistenceType;
import com.vs.rappit.jersey.base.webservice.BaseWebService;
import com.minatodattebayo.gittestapp.base.service.ITableBaseService;
...
public abstract class TableBaseController<SERVICE extends ITableBaseService<M>, M extends TableBase>
		extends BaseWebService<SERVICE, M> {
	
	
	public TableBaseController(SERVICE logic) {
		super(logic);
	}
	@PreAuthorize("hasAccess('/tables/{ids}')")
	@DeleteMapping("/{ids}")
	...
	@PreAuthorize("hasAccess('/tables/datatable')")
	...
	@PreAuthorize("hasAccess('/tables/autosuggest')")
	...
	@PreAuthorize("hasAccess('/tables/{sid}')")
