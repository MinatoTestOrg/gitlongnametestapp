package com.minatodattebayo.gittestapp.base.service;
...
import com.minatodattebayo.gittestapp.base.model.TableBase;
import java.util.List;
...
public class TableBaseService<T extends TableBase> extends BaseBusinessLogic<T>
		implements ITableBaseService<T> {
	...
	public TableBaseService(Class<T> modelClass) {
		super(modelClass);
	...
	public void onAfterSaveDB(T modelObj) {
	  changelogService.createChangeLog("Table", modelObj.getSid(), Constants.SAVED, modelObj);
	}
	...
	public void onAfterUpdateDB(T modelObj) {
	  changelogService.createChangeLog("Table", modelObj.getSid(), Constants.UPDATED, modelObj);
	}
	...
	public void onAfterDeleteDB(T modelObj) {
	  changelogService.createChangeLog("Table", modelObj.getSid(), Constants.DELETED, modelObj);
	}	
